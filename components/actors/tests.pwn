...
@test(.group = "actors") A_01_CreateActor()
{
...
@test(.group = "actors") A_02_GetActorPoolSize()
{
...
@test(.group = "actors") A_03_GetAndSetActorVW()
{
...
@test(.group = "actors") A_04_GetAndSetActorPos()
{
...
@test(.group = "actors") A_05_IsAndSetActorInv()
{
    g_iActor = CreateActor(0, 0.0, 0.0, 0.0, 0.0);
...
@test(.group = "actors") A_06_GetAndSetActorHealth()
{
    g_iActor = CreateActor(0, 0.0, 0.0, 0.0, 0.0);
    new Float:health;
...
@test(.group = "actors") A_07_GetAndSetActorFacingA()
{
...
@test(.group = "actors") A_08_IsValidActor()
{
    g_iActor = CreateActor(0, 0.0, 0.0, 0.0, 0.0);
...
@test(.group = "actors") A_09_DestroyActor()
{
    g_iActor = CreateActor(0, 0.0, 0.0, 0.0, 0.0);
