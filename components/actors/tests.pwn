...
TEST__ A_03_GetAndSetActorVW()
{
    ...
    ASSERT_EQ(SetActorVirtualWorld(INVALID_ACTOR_ID, 69), false);
...
TEST__ A_04_GetAndSetActorPos()
{
    ...
    ASSERT_EQ(GetActorPos(INVALID_ACTOR_ID, x, y, z), false);
    ASSERT_EQ(SetActorPos(INVALID_ACTOR_ID, 1.0, 2.0, 3.0), false);

    ASSERT_EQ(GetActorPos(g_iActor, x, y, z), true);
    ASSERT_EQ(x, 1.0);
    ASSERT_EQ(y, 2.0);
    ASSERT_EQ(z, 3.0);
    ASSERT_EQ(SetActorPos(g_iActor, 10.0, 20.0, 3.0), true);
    ASSERT_EQ(GetActorPos(g_iActor, x, y, z), true);
    ASSERT_EQ(x, 10.0);
    ASSERT_EQ(y, 20.0);
    ASSERT_EQ(z, 3.0);
...
{
    g_iActor = CreateActor(0, 0.0, 0.0, 0.0, 0.0);
    ASSERT_EQ(IsActorInvulnerable(INVALID_ACTOR_ID), false);
    ASSERT_EQ(SetActorInvulnerable(INVALID_ACTOR_ID, true), false);

    ASSERT_EQ(IsActorInvulnerable(g_iActor), true);
    ASSERT_EQ(SetActorInvulnerable(g_iActor, false), true);
    ASSERT_EQ(IsActorInvulnerable(g_iActor), false);
}
...
TEST__ A_06_GetAndSetActorHealth()
{
    ...
    ASSERT_EQ(GetActorHealth(INVALID_ACTOR_ID, health), false);
    ASSERT_EQ(SetActorHealth(INVALID_ACTOR_ID, 69.0), false);

    ASSERT_EQ(GetActorHealth(g_iActor, health), true);
    ASSERT_EQ(health, 100.0);
    ASSERT_EQ(SetActorHealth(g_iActor, 69.0), true);
    ASSERT_EQ(GetActorHealth(g_iActor, health), true);
...
TEST__ A_07_GetAndSetActorFacingA()
{
    ...
    ASSERT_EQ(GetActorFacingAngle(INVALID_ACTOR_ID, angle), false);
    ASSERT_EQ(SetActorFacingAngle(INVALID_ACTOR_ID, 69.0), false);

    ASSERT_EQ(GetActorFacingAngle(g_iActor, angle), true);
    ASSERT_EQ(angle, 30.0);
    ASSERT_EQ(SetActorFacingAngle(g_iActor, 69.0), true);
    ASSERT_EQ(GetActorFacingAngle(g_iActor, angle), true);
...
TEST__ A_08_IsValidActor()
{
    ...
    ASSERT_EQ(IsValidActor(INVALID_ACTOR_ID), false);
    ASSERT_EQ(IsValidActor(g_iActor), true);
}

TEST_CLOSE__ A_08_IsValidActor()
{
    DestroyActor(g_iActor);
    ASSERT_EQ(IsValidActor(g_iActor), false);
}
...
TEST__ A_09_DestroyActor()
{
    ...
    ASSERT_EQ(DestroyActor(INVALID_ACTOR_ID), false);
    ASSERT_EQ(DestroyActor(g_iActor), true);
    ASSERT_EQ(DestroyActor(g_iActor), false);
}
