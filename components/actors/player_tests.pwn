...
@test(.group = "actors") A_10_CreateActor(playerid)
{
...
@testclose() A_10_CreateActor(playerid)
{
    DestroyActor(g_iActor);
}

@test(.group = "actors") A_11_SetActorPos(playerid)
{
...
@testclose() A_11_SetActorPos(playerid)
{
    DestroyActor(g_iActor);
}

@test(.group = "actors") A_12_SetActorVirtualWorld(playerid)
{
    g_iActor = CreateActor(0, 1000.0, 1005.0, 50.0, 180.0);
...
@testclose() A_12_SetActorVirtualWorld(playerid)
{
    SetPlayerVirtualWorld(playerid, 0);
    DestroyActor(g_iActor);
}

@test(.group = "actors") A_13_SetActorInvulnerable(playerid)
{
    g_iActor = CreateActor(0, 1000.0, 1005.0, 50.0, 180.0);
    ASSERT(SetActorInvulnerable(g_iActor, false));
    ASK("Are you able to hit the actor?");
}
@testclose() A_13_SetActorInvulnerable(playerid)
{
    DestroyActor(g_iActor);
}

@test(.group = "actors") A_14_SetActorFacingAngle(playerid)
{
    g_iActor = CreateActor(0, 1000.0, 1005.0, 50.0, 180.0);
    ASSERT(SetActorFacingAngle(g_iActor, 0.0));
    ASK("Is the actor facing north?");
}
@testclose() A_14_SetActorFacingAngle(playerid)
{
    DestroyActor(g_iActor);
}

@test(.group = "actors") A_15_ApplyActorAnimation(playerid)
{
    g_iActor = CreateActor(0, 1000.0, 1005.0, 50.0, 180.0);
...
@testclose() A_15_ApplyActorAnimation(playerid)
{
    DestroyActor(g_iActor);
}

@test(.group = "actors") A_16_ClearActorAnimations(playerid)
{
    g_iActor = CreateActor(0, 1000.0, 1005.0, 50.0, 180.0);
...
@testclose() A_16_ClearActorAnimations(playerid)
{
    DestroyActor(g_iActor);
}

@test(.group = "actors") A_17_GetPlayerTargetActor(playerid)
{
    g_iActor = CreateActor(0, 1000.0, 1005.0, 50.0, 180.0);
...
@testclose() A_17_GetPlayerTargetActor(playerid)
{
...
@test(.group = "actors") A_18_GetPlayerCameraTA(playerid)
{
...
@testclose() A_18_GetPlayerCameraTA(playerid)
{
...
@test(.group = "actors") A_19_GetPlayerCameraTA(playerid)
{
    EnablePlayerCameraTarget(playerid, true);
    g_iActor = CreateActor(0, 1000.0, 1005.0, 50.0, 180.0);
...
@testclose() A_19_GetPlayerCameraTA(playerid)
{
...
@test(.group = "actors") A_20_IsActorStreamedIn(playerid)
{
...
@testclose() A_20_IsActorStreamedIn(playerid)
{
    ASSERT(IsActorStreamedIn(g_iActor, playerid));
